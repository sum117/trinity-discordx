import type { CommandInteraction, GuildMember, InteractionResponse } from "discord.js";
...
export class Utilities {
    ...
    public async userProfile(
        ...
        const userStats = (await characters).reduce((acc, curr) => {
            acc.characters++;
        ...
        const attachment = new AttachmentBuilder(userProfileBuffer)
            .setName("user_profile.png");
