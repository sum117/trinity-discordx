...
INSERT INTO "new_Char" ("authorId", "color", "createdAt", "description", "id", "image", "letters", "name", "prefix") SELECT "authorId", "color", "createdAt", "description", "id", "image", "letters", "name", "prefix" FROM "Char";
DROP TABLE "Char";
